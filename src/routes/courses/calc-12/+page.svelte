...
<section class="course-header">
    <div class="container">
        ...
        <h1 class="course-title">Calculus 12</h1>
        <p class="course-description">
            Pre-Calculus and Calculus 12 - BC Curriculum. Advanced mathematics
            including limits, derivatives, integrals, and their real-world
            applications.
        </p>
    </div>
</section>
